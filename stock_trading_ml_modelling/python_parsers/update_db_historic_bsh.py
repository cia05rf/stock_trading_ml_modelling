...
import pandas as pd
import logging
from stock_trading_ml_modelling.config import WS_UPDATE_SIGNALS_LOG, \
    SIGNALS, DB_UPDATE_PRICES, DB_UPDATE_SIGNALS


log_file = WS_UPDATE_SIGNALS_LOG
...
for tick in tick_li:
    try:
        ...
        if cur.rowcount > 0:
            ...
            ticker_id = None
        logging.info(
            'TICKER FOR {} ID ESTABLISHED AS -> {}'.format(tick.upper(), ticker_id))
